...
const Task = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].models.Task || __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model('Task', TaskSchema);
}}),
...
async function PATCH(req, context) {
    ...
    try {
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Task$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Task"].findByIdAndUpdate(id, body, {
            new: true
        });
        if (!updated) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(req, context) {
    ...
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectToDatabase"])();
        const deleted = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Task$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Task"].findByIdAndDelete(id);
        if (!deleted) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Task not found'
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__59838327._.js.map