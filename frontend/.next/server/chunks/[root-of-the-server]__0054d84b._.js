...
async function GET() {
    try {
        ...
        const tasks = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Task$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Task"].find().sort({
            createdAt: -1
        });
...
async function POST(req) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectToDatabase"])();
        const newTask = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Task$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Task"].create({
            title
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0054d84b._.js.map