...
"[project]/.next-internal/server/app/api/tasks/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/server.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$tasks$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/api/tasks/route.ts [app-route] (ecmascript)");
;
;
async function PATCH(req, context) {
    const { id } = context.params;
    const body = await req.json();
    const task = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$tasks$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tasks"].find((t)=>t.id === id);
    if (!task) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(_, context) {
    const { id } = context.params;
    const index = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$tasks$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tasks"].findIndex((t)=>t.id === id);
    if (index === -1) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Task not found'
        }, {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$tasks$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tasks"].splice(index, 1);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        success: true
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eb36e38a._.js.map