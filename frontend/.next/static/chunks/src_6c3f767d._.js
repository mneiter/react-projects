...
"[project]/src/sevicies/tasksService.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
_s(AddTaskForm, "NCtYNOvrRcENidyoebV8+8OnNi4=");
_c = AddTaskForm;
var _c;
...
"[project]/src/components/tasks/FilterButtons.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
_c = FilterButtons;
var _c;
__turbopack_context__.k.register(_c, "FilterButtons");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
const TaskList = ({ tasks, toggleTask, removeTask, editTask, isClient, filter })=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
        className: "space-y-2",
        children: [
            filteredTasks.map((task)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
...
_s(TaskList, "cPyRxo1mfZyT/lXSzJfZKv2HGiM=");
_c = TaskList;
var _c;
...
const TaskStats = ({ tasks })=>{
    ...
    const { total, active, completed } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TaskStats.useMemo": ()=>{
            const total = tasks.length;
            const active = tasks.filter({
                "TaskStats.useMemo": (task)=>!task.completed
            }["TaskStats.useMemo"]).length;
...
_s(TaskStats, "KMlC8PZCBeP2S6mSbVzDKp4q9PI=");
_c = TaskStats;
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sevicies$2f$tasksService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/sevicies/tasksService.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$tasks$2f$FilterButtons$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/tasks/FilterButtons.tsx [app-client] (ecmascript)");
...
const TaskManager = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TaskManager.useEffect": ()=>{
            const loadTasks = {
                "TaskManager.useEffect.loadTasks": async ()=>{
                    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sevicies$2f$tasksService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchTasks"])();
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].log("Fetched tasks:", data);
                    if (!Array.isArray(data)) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error("Invalid data format:", data);
                        setIsLoading(false);
                        return;
                    }
                    setTasks(data);
            ...
            }["TaskManager.useEffect.loadTasks"];
            loadTasks();
        }
    }["TaskManager.useEffect"], []);
    const addTask = async (title)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].log("Adding new task with title:", title);
        try {
            const newTask = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sevicies$2f$tasksService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createTask"])(title);
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].log("New task created:", newTask);
            setTasks((prev)=>[
                    ...prev,
                    newTask
                ]);
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error("Error creating task:", error);
        }
    };
    const toggleTask = async (id)=>{
        const task = tasks.find((t)=>t.id === id);
        if (!task) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].warn(`Task with id ${id} not found.`);
            return;
        }
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].log(`Toggling task with id ${id}. Current state:`, task);
        task.completed = !task.completed;
        const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sevicies$2f$tasksService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateTask"])(id, task);
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].log(`Task with id ${id} updated. New state:`, updated);
        setTasks((prev)=>prev.map((t)=>t.id === id ? updated : t));
    };
    const editTask = async (id, title)=>{
        const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sevicies$2f$tasksService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateTask"])(id, {
            title
        });
        setTasks((prev)=>prev.map((t)=>t.id === id ? updated : t));
    };
    const removeTask = async (id)=>{
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sevicies$2f$tasksService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteTask"])(id);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$tasks$2f$FilterButtons$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FilterButtons"], {
                filter: filter,
                setFilter: setFilter
            }, void 0, false, {
                fileName: "[project]/src/components/TaskManager.tsx",
...
//# sourceMappingURL=src_6c3f767d._.js.map