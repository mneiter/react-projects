...
const TaskManager = ()=>{
        ...
        "TaskManager.useEffect": ()=>{
            const loadTasks = {
                "TaskManager.useEffect.loadTasks": async ()=>{
                    try {
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sevicies$2f$tasksService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTasks"])();
    ...
    const handleAddTask = async (title)=>{
        try {
            const newTask = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sevicies$2f$tasksService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createTask"])({
                title
            });
            setTasks((prev)=>[
                    ...prev,
...
//# sourceMappingURL=src_db3d7ab2._.js.map